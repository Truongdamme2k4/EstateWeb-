                ...
                <div class="col-xs-12">
                    <div class="widget-box">
                        ...
                        <div class="widget-body" style="font-family:'Times New Roman', Times, serif">
                            <div class="widget-main searchForm">
                                <form:form modelAttribute="modelSearch" id="listForm" action="${buildingListURL}" method="GET">
                                     <div class="row">
                                        ...
                                        <div class="col-4">
                                            <form:input class="form-control" path="rentPriceFrom" placeholder="Giá thuê từ"/>
                                        </div>
                                        <div class="col-4" >
                                            <form:input class="form-control" path="rentPriceTo" placeholder="Giá thuê đến"/>
                                        </div>
                                     </div>

                                     <div class="row" style="margin-top: 30px;">
                                        <div class="col-4" >
                                            <form:input class="form-control" path="areaFrom" placeholder="Diện tích từ" />
                                        </div>
                                        <div class="col-4" >
                                            <form:input class="form-control" path="areaTo" placeholder="Diện tích đến"/>
                                        </div>
                                        <div class="col-4" >
                        ...
                        <div class="row">
                            <c:forEach var="item" items="${buildingList}">
                                <div class="col-12 col-md-4">
                                    <div class="product1 ">
                                        <div class="new" style="background: url(https://i.pinimg.com/736x/22/0e/e0/220ee05da30aee0e80cd0965bb370255.jpg) center / cover no-repeat;
                                                                                                 width:100%;
                                                                                                 height: 12rem;"></div>
